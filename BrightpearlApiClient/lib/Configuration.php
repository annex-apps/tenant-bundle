...
class Configuration
{
     ...
     *
     * @var \BrightpearlApiClient\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'https://api.james-dev-vm.brightpearl.com/public-api';
    ...
    {
        $report  = "PHP SDK (BrightpearlApiClient) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
        $report .= "    PHP Version: ".phpversion()."\n";
        $report .= "    OpenAPI Spec Version: 2.0.0\n";
