...
use \ArrayAccess;
/**
 * Customfieldpatch1 Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     BrightpearlApiClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Customfieldpatch1 implements ArrayAccess
{
    /**
    ...
    {
        $allowed_values = array("add", "remove", "replace");
        if (!in_array($op, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'op', must be one of 'add', 'remove', 'replace'");
        }
        $this->op = $op;
        return $this;
    }
