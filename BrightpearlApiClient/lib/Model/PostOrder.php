...
class PostOrder implements ArrayAccess
{
    ...
    static $swaggerTypes = array(
        ...
        'placed_on' => 'string',
        'order_status' => '\BrightpearlApiClient\Model\PostOrderOrderStatus',
        'delivery' => '\BrightpearlApiClient\Model\OrderDelivery',
        'invoices' => '\BrightpearlApiClient\Model\PostOrderInvoices[]',
        'order_currency_code' => 'string',
        'parties' => '\BrightpearlApiClient\Model\PostOrderParties',
        'assignment' => '\BrightpearlApiClient\Model\PostOrderAssignment',
        'warehouse_id' => 'int'
    );
