 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrderPatchCommand implements ArrayAccess
{
    /**
    ...
    {
        $allowed_values = array("replace", "remove");
        if (!in_array($op, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'op', must be one of 'replace', 'remove'");
        }
        $this->op = $op;
        return $this;
    }
