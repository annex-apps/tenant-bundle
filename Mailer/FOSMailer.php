 ...
 *
 */
namespace Annex\TenantBundle\Mailer;
...
class FOSMailer implements MailerInterface
{
    ...
    public function sendConfirmationEmailMessage(UserInterface $user)
    {
        ...
        $fromCompanyName = "Annex Apps";
        $replyToEmail    = "hello@annex-apps.com";
        ...
        $client = new PostmarkClient($this->container->getParameter('annex.postmark_api_key'));
        $client->sendEmail(
