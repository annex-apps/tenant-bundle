...
class Contact implements ArrayAccess
{
    ...
    static $swaggerTypes = array(
        ...
        'first_name' => 'string',
        'last_name' => 'string',
        'post_address_ids' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactPostAddressIds',
        'postal_addresses' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\PostalAddress[]',
        'communication' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactCommunication',
        'contact_status' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactContactStatus',
        'relationship_to_account' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactRelationshipToAccount',
        'marketing_details' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactMarketingDetails',
        'financial_details' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactFinancialDetails',
        'assignment' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactAssignment',
        'organisation' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactOrganisation',
        'trade_status' => 'string',
        'created_byid' => 'int',
        'created_on' => 'string',
        'updated_on' => 'string',
        'custom_fields' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\CustomField',
        'contact_tags' => 'string',
        'aliases' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ContactAliases'
    );
