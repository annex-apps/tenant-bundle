...
class OrderRowRowValue implements ArrayAccess
{
    ...
    static $swaggerTypes = array(
        'tax_rate' => 'string',
        'row_net' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\OrderRowItemCost',
        'tax_code' => 'string',
        'row_tax' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\OrderRowItemCost'
    );
