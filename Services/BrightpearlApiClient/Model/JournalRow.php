...
class JournalRow implements ArrayAccess
{
    ...
    static $swaggerTypes = array(
        'nominal_code' => 'string',
        'change' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\JournalRowAmount',
        'assignment' => '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\JournalRowAssignment',
        'order_id' => 'int',
