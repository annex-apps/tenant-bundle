...
namespace Annex\TenantBundle\Services\BrightpearlApiClient;
...
class ApiClient
{
     ...
     * @param Logger $logger
     */
    public function __construct(Configuration $config = null, Logger $logger = null)
    {
        if ($config == null) {
     ...
     * @throws \BrightpearlApiClient\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null)
    {
        ...
        if ($response_info['http_code'] == 0) {
            ...
            throw new ApiException(
                "[".$response_info['http_code']."] Error connecting to the API ($url) {$msg}",
