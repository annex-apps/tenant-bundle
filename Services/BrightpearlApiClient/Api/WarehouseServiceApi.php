    ...
    public function getWarehouseFulfilmentSourceWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20040'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20040', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20040', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function postWarehouseGoodsOutNoteWithHttpInfo($account_code, $id, $goods_out_note = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'POST',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20041'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20041', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20041', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
...
//        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20042'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20042', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20042', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehouseGoodsInNotesWithHttpInfo($account_code, $order_id_set, $goods_in_note_id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20043'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20043', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20043', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function postWarehouseDropShipNoteWithHttpInfo($account_code, $order_id, $warehouse = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'POST',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20044'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20044', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20044', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehouseGoodsOutNoteWithHttpInfo($account_code, $order_id, $goods_out_note_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20045'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20045', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20045', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehouseProductAvailabilityWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20046'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20046', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20046', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehouseOrderReservationsWithHttpInfo($account_code)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20047'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20047', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20047', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehouseShippingMethodsWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20048'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20048', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20048', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehousesBundleAbailabilityWithHttpInfo($account_code, $product_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20049'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20049', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20049', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getWarehouseDefaultLocationWithHttpInfo($account_code, $id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20050'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20050', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20050', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
...
//        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20051'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20051', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20051', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
