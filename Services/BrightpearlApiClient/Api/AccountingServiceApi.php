    ...
    public function getAccountingAccountingPeriodIDSetWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2001'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2001', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2001', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
    ...
    public function getAccountingJournalIDSetWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\JournalGetResponse'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\JournalGetResponse', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\JournalGetResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
    ...
    public function getAccountingNominalCodeIDSetWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\NominalCodeGetResponse'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\NominalCodeGetResponse', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\NominalCodeGetResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
    ...
    public function getAccountingPaymentAuthIDSetWithHttpInfo($account_code, $id_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2004'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2004', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2004', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
    ...
    public function getAccountingTaxCodeWithHttpInfo($account_code)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2005'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2005', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse2005', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
