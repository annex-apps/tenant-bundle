    ...
    public function getOrderStatusWithHttpInfo($account_code)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20020'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20020', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20020', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getOrderStockStatusWithHttpInfo($account_code)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20021'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20021', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20021', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getOrderTypeWithHttpInfo($account_code)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20022'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20022', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20022', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    public function getOrdersIDSetWithHttpInfo($account_code, $idid_set)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20023'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20023', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20023', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
...
//        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20024'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20024', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20024', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 404:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
    ...
    public function patchOrderRowWithHttpInfo($account_code, $order_id, $order_row_id, $order_row_patch)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'PATCH',
                $queryParams, $httpBody,
                $headerParams, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20025'
            );
            ...
            return array(ObjectSerializer::deserialize($response, '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20025', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\InlineResponse20025', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 500:
                $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Annex\TenantBundle\Services\BrightpearlApiClient\Model\ErrorModel', $e->getResponseHeaders());
